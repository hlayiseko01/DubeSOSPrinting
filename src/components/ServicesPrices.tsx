...
export default function ServicesPrices() {
  ...
  const framedWaText = encodeURIComponent(`Hello DubeSOS Printing! I am interested in your A4 Framed Photo service. Please guide me on ordering normal or customised frames.`);
  ...
  const listItemsFramed = [
    ...
    'Customized frames can include text & overlays',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl border border-gray-light-border p-8 flex flex-col justify-between hover:shadow-lg transition-all duration-300 relative overflow-hidden group shadow-sm animate-fade-in"
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-dark-main uppercase tracking-tight">A4 Framed Photos</h3>
                  <p className="text-xs text-brand-orange font-semibold">Perfect Special Presents</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-center">
                  <p className="text-xs text-gray-muted font-medium">Normal Frame</p>
                  <p className="text-2xl font-black text-dark-main mt-1">
                    R {PRICING.framed.normal}
                    <span className="text-xs text-gray-muted font-medium"> /unit</span>
                  </p>
                </div>
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 text-center">
                  <p className="text-xs text-gray-muted font-medium">Customised Frame</p>
                  <p className="text-2xl font-black text-brand-orange mt-1">
              ...
              {/* Inclusions list */}
              <div className="space-y-3.5 mb-8">
                <p className="text-xs text-gray-muted font-bold uppercase tracking-wider">Cherish Your Moments:</p>
            ...
            >
              <MessageSquare className="w-4 h-4 fill-current" />
              <span>Order Framed Photos via WhatsApp</span>
            </a>
          </motion.div>
